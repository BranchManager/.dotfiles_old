...
Rectangle {
    ...
    Row {
        ...
        Item {
            ...
            Image {
                ...
                height: 22
                width: 100
                source: "/usr/share/sddm/themes/ROUNDED-DARK/images/system-shutdown.svg" 
                //"/usr/share/sddm/themes/ROUNDED-DARK/images/power_test.jpg"  
    ...
    Row {
        ...
        //Noah note: The above line will center the text in the code ID'ed by "panel"
        //so it will be centered in the panel
       
        Text {
            id: timelb
            text: Qt.formatDateTime(new Date(), "MMM d,YYYY hh:mm ap")
            color: "#eff0f1"
            font.pointSize: 11
        }
    }
